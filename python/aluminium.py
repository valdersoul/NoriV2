...
import numpy as np
from utils.materials import aluminium
...
print('Computing aluminium IOR parameters')
eta_bot = get_rgb(aluminium)
...
storage = ll.BSDFStorage.fromLayerRGB("aluminiumLL.bsdf", *lloutput )
storage.close()
...
print("Writing to disk..")
storage = ll.BSDFStorage.fromLayerRGB("ourOutputAluminium.bsdf", *outputForReal)
storage.close()
